...
use permissions::manage_permissions;
use status::show_claude_status_table;
    ...
    match cli.command {
        ...
        Commands::Claude { command } => match command {
            ...
            ClaudeCommands::Status => {
                show_claude_status_table()
            }
            ClaudeCommands::Permissions => {
                manage_permissions("projectfiles".to_string())
            }
            ClaudeCommands::Configure => {
